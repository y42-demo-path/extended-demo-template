...
def retl_mart_gsheet(context, assets):
    ...
    df = assets.ref('mrt_revenue_by_payment_method')
    ...
    service_account_info = json.loads(context.secrets.get('<Add your Secret here>'))
    ...
    sht1 = client.open_by_key('<add Gsheet ID here>')
